      ...
      <div class="container-fluid">
        ...
        <?php
          ...
          <tr>
            ...
            <td><a href="fromadd.php?addraw_id=<?php echo $row['mt_id'] ?>"class="btn btn-primary">เพิ่ม</td>

            <td><a href="fromwithdraw.php?withdraw_id=<?php echo $row['mt_id'] ?>"class="btn btn-warning">เบิก</td> 
          </tr>
          <?php
            }
            ?>
